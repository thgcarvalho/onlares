	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				...
				<form id="myform" class="form-horizontal message-form col-xs-12" action="${ctx}/adminMensagem/" method="post" >
				
					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="form-field-subject">Para:</label>
						<div class="col-sm-6 col-xs-12">
							<input maxlength="100" type="text" class="col-xs-12" name="para" id="form-field-subject" value="Todos" disabled="disabled"/>
						</div>
					</div>
