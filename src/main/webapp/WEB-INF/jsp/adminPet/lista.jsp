								...
								<c:otherwise>
									<c:forEach items="${petList}" var="pet">
										<tr>
											...
											<td>${pet.raca}</td>
											<td>${pet.nome}</td>
											<td>${pet.unidade.descricao}</td>
											<td>
												<div class="hidden-sm hidden-xs action-buttons">
													<a class="editar" href="${linkTo[AdminPetController].edita(pet.id)}" 
														title="Editar" >
														<i class="ace-icon fa fa-pencil bigger-130"></i>
													</a>
													
													<a class="deletar" href="${linkTo[AdminPetController].remove(pet.id)}" 
	                    								title="Remover" >
												...
												<div class="hidden-md hidden-lg">
													<div class="inline pos-rel">
														...
														<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
															<li>
																<a href="${linkTo[AdminPetController].edita(pet.id)}" 
															...
															<li>
																<a href="${linkTo[AdminPetController].remove(pet.id)}" 
