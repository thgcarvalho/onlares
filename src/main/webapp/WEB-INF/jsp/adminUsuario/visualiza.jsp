			...
			<div class="col-xs-12">
				...
				<div class="form-horizontal">
					...
					<div class="form-group">
						<label class="info-name col-sm-3 control-label no-padding-top"> Nome: </label>
					...
					<div class="form-group">
						<label class="info-name col-sm-3 control-label no-padding-top"> Email Principal: </label>
						<div class="info-value col-sm-9">
					...
					<div class="form-group">
						<label class="info-name col-sm-3 control-label no-padding-top"> Email Secundário: </label>
						<div class="info-value col-sm-9">
					...
					<div class="form-group">
						<label class="info-name col-sm-3 control-label no-padding-top"> CPF/CNPJ: </label>
						<div class="info-value col-sm-9">
					...
					<div class="form-group">
						<label class="info-name col-sm-3 control-label no-padding-top"> Fone Residencial: </label>
						<div class="info-value col-sm-9">
					...
					<div class="form-group">
						<label class="info-name col-sm-3 control-label no-padding-top"> Fone Celular: </label>
						<div class="info-value col-sm-9">
					...
					<div class="form-group">
						<label class="info-name col-sm-3 control-label no-padding-top"> Fone Comercial </label>
						<div class="info-value col-sm-9">
					...
					<div class="form-group">
						<label class="info-name col-sm-3 control-label no-padding-top"> Logradouro: </label>
						<div class="info-value col-sm-9">
							<span>${usuario.logradouro}</span>
						</div>
					</div>
					
					<div class="form-group">
						<label class="info-name col-sm-3 control-label no-padding-top"> Complemento: </label>
						<div class="info-value col-sm-9">
					...
					<div class="form-group">
						<label class="info-name col-sm-3 control-label no-padding-top"> Bairro: </label>
						<div class="info-value col-sm-9">
					...
					<div class="form-group">
						<label class="info-name col-sm-3 control-label no-padding-top"> Cidade: </label>
						<div class="info-value col-sm-9">
					...
					<div class="form-group">
						<label class="info-name col-sm-3 control-label no-padding-top" for="uf"> UF: </label>
						<div class="info-value col-sm-9">
					...
					<div class="form-group">
						<label class="info-name col-sm-3 control-label no-padding-top" for="cep"> CEP: </label>
						<div class="info-value col-sm-9">
					...
					<div class="form-group">
						<div class="info-name col-sm-3 control-label no-padding-top"> Unidade: </div>
						<div class="info-value col-sm-9">
