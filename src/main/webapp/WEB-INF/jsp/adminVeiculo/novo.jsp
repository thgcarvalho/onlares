...
<div class="main-content-inner">
	<div class="breadcrumbs" id="breadcrumbs">
		...
		<ul class="breadcrumb">
			...
			<li>
			<i class=""></i>
				<a href="${ctx}/adminVeiculo/lista">Veículos</a>
			</li>
	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				<!-- PAGE CONTENT BEGINS -->
				<form class="form-horizontal" role="form" action="${ctx}/adminVeiculo/" method="post">
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<select name="veiculo.unidade.id" class="col-xs-10 col-sm-5" id="form-field-select-4" data-placeholder="Selecione a unidade...">
								<c:forEach items="${unidadeList}" var="unidade" >							
									<c:choose>
										<c:when test="${veiculo.unidade.id == unidade.id}">
