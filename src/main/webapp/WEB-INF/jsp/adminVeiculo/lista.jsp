				...
				<div class="row">
					<div class="col-xs-12">
						<table id="simple-table" class="table table-striped table-bordered table-hover">
							...
							<tbody>
								<c:choose>
								<c:when test="${veiculoList.isEmpty()}">
								    <tr>
								...
								<c:otherwise>
									<c:forEach items="${veiculoList}" var="veiculo">
										<tr>
											...
											<td>${veiculo.cor}</td>
											<td>${veiculo.unidade.descricao}</td>
											<td>
												<div class="hidden-sm hidden-xs action-buttons">
													<a class="editar" href="${linkTo[AdminVeiculoController].edita(veiculo.id)}" 
														title="Editar" >
														<i class="ace-icon fa fa-pencil bigger-130"></i>
													</a>
													
													<a class="deletar" href="${linkTo[AdminVeiculoController].remove(veiculo.id)}" 
	                    								title="Remover" >
												...
												<div class="hidden-md hidden-lg">
													<div class="inline pos-rel">
														...
														<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
															<li>
																<a href="${linkTo[AdminVeiculoController].edita(veiculo.id)}" 
															...
															<li>
																<a href="${linkTo[AdminVeiculoController].remove(veiculo.id)}" 
...
<content tag="local_script">
	...
	<script type="text/javascript">
		...
		window.onload = function() {
			document.getElementById('menuadmin_veiculos').className = 'active';
		};
	</script>
